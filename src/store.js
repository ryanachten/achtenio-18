const projects = {
  ...
  hiko: {
    ...
    credits:  [
                ...
                {name: 'Walter Langelaar', role: 'Supervision'},
                {name: 'Matt Plummer', role: 'Supervision'}
              ],
    tools: ['Sketch App', 'Maxon Cinema 4D', 'WordPress', 'PHP', 'JavaScript'],
    social: [
      { host: 'GitHub',
      url: 'https://github.com/ryanachten/Hiko' },
      { host: 'Behance',
  ...
  vertice: {
    ...
    social: [
      ...
      { host: 'Behance',
      url: 'https://www.behance.net/gallery/60149489/Vertice-II-3D-Archive-Interface-(WebGL)' },
      { host: 'Behance',
